  ...
  return (
    <motion.div className="space-y-6" initial="hidden" animate="visible">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 bg-clip-text text-transparent text-2xl font-bold">Teacher Dashboard</h1>
          <p className="text-gray-500">Welcome back, {user.name.split(' ')[1] || user.name.split(' ')[0]}!</p>
        </div>
        <button onClick={onLogout} className="flex items-center gap-2 px-4 py-2 border rounded-lg hover:bg-gray-100">
      ...
      <div className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 border rounded-lg shadow">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="flex items-center gap-2"><IdCard className="h-4 w-4 text-gray-500" /><div><p className="text-sm text-gray-500">Faculty ID</p><p className="font-medium">{user.teacherId}</p></div></div>
          <div className="flex items-center gap-2"><User className="h-4 w-4 text-gray-500" /><div><p className="text-sm text-gray-500">Full Name</p><p className="font-medium">{user.name}</p></div></div>
